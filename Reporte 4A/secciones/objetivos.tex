...
\begin{itemize}
	...
	\item \textbf{Analizar} el efecto de la selectividad del circuito sobre la respuesta del sistema, centrando la atención en los detalles esenciales para la correcta aplicación de los principios fundamentales de la ingeniería.
\end{itemize}